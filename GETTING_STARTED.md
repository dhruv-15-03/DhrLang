...
1. Download `dhrlang-vscode-1.1.8.vsix` from [Releases](https://github.com/dhruv-15-03/DhrLang/releases/latest).
...
2. Download `DhrLang-1.1.8.jar` (fat JAR with all dependencies)
3. Run: `java -jar DhrLang-1.1.8.jar input/sample.dhr`
...
cd DhrLang
./gradlew shadowJar
java -jar build/libs/DhrLang-1.1.8.jar input/sample.dhr
```

### CLI Options
```bash
--help           Show usage and options
--version        Print version (e.g., "DhrLang version 1.1.8")
