...
/**
 * Iteration 3 – EVM Backend: Bytecode Generation & Deployment
 *
...
class Iteration3EvmBackendTest {
    ...
    class AbiGeneratorTests {
        ...
        void solidityTypeMapping() {
            ...
            assertEquals("string", AbiGenerator.solidityType("str"));
            assertEquals("bool", AbiGenerator.solidityType("bool"));
    ...
    class IntegrationTests {
        ...
        @Test
        @DisplayName("end-to-end: compile contract → get bytecode + ABI")
